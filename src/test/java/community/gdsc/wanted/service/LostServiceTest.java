...
class LostServiceTest {
    ...
    public void writeLost() {
        ...
        assertThat(lost.getLostcol()).isEqualTo(savedLost.getLostcol());
    ...
    public void modifyLost() {
        ...
        modifingLost.setLostcol("modify lost");
        Timestamp currentTimestamp = new Timestamp(System.currentTimeMillis());
        ...
        assertThat(modifingLost.getLostcol()).isEqualTo(savedLost.getLostcol());
